...
<table width="500" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td><br>
			<form  name="form" method="post" action="zipcode.php?kind=<?= $kind ?>">
...
<table width="500" border="0" cellpadding="0" cellspacing="0">
            ...
            <?
               if ($text1 && $sel != 0) {
                  ...
                  for ($i = 0; $i < $count; $i++) {
                     ...
                     echo("
                        <option value='$zip^^$A'>[$zip] $A</option>  
                     ");
                  }
               } else {
                  echo("<option></option>");
	...
	<tr height="55">
		<td align="center">
			<?php
				// if ($zip_kind === 1)
				// 	echo("<a href='javascript:SendZip(1)'><img src='images/b_ok1.gif' border='0'></a>");
				// else if ($zip_kind === 2)
				// 	echo("<a href='javascript:SendZip(2)'><img src='images/b_ok1.gif' border='0'></a>");
				// else
				// 	echo("<a href='javascript:SendZip(0)'><img src='images/b_ok1.gif' border='0'></a>");
			?>
			<a href='javascript:SendZip(<?= $kind2 ?>)'><img src='images/b_ok1.gif' border='0'></a>
		</td>
	</tr>
</form>
</table>
