...
<?
	$query = "select * from sj where no31=$no;";
	$result=mysqli_query($db, $query);
	if (!$result) exit("에러:$query");

	$row=mysqli_fetch_array($result);
	$avg=sprintf("%6.1f", $row['avg31']);
?>
...
<table width="300" border="1" cellpadding="2" bgcolor="lightyellow" style="border-collapse:collapse">
  <tr>
    ...
    <td width="200">
      <input type="text" name="name" size="20" value="<?=$row['name31'] ?>">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">국어</td>
    <td width="200">
      <input type="text" name="kor" size="6" value="<?=$row['kor31'] ?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">영어</td>
    <td width="200">
      <input type="text" name="eng" size="6" value="<?=$row['eng31'] ?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">수학</td>
    <td width="200">
      <input type="text" name="mat" size="6" value="<?=$row['mat31'] ?>" onChange="javascript:cal_jumsu();">
    </td>
  </tr>
  <tr>
    <td width="100" align="center" bgcolor="lightblue">총점</td>
    <td width="200">
      <input type="text" name="hap" size="6" value="<?=$row['hap31'] ?>" readonly style="border:0;background-color:#ffffe0">
    </td>
  </tr>
  <tr>
