...
<table width="1500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr> 
	...
	<tr> 
		<td> 
			<table width="1500" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<!-- <td valign="center" align="center"><a href="index.html"><img src="images/footer_logo.gif" border="0"></a></td> -->
					<td width="28"></td>
					<td> 
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr> 
											...
											<td><img src="images/footer_line.gif" width="3" height="42"></td>
